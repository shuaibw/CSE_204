...
public class ArrayTest {
    public static void main(String[] args) {
        ...
        try {
            Array<String> invalid = new Array<>(-10);
        } catch (Exception e) {
            System.out.println(e.getMessage());
        }
        try {
            Array<String> invalid = new Array<>(null);
        } catch (Exception e) {
            System.out.println(e.getMessage());
        }
        try {
    ...
    private static void testSimpleMethods(Array<String> ara) {
        System.out.printf("Array<String>length: %d\n", ara.length());
        System.out.printf("Array<String>size: %d\n", ara.size());
